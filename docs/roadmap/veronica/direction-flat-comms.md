...
> 上層設計：[`veronica-design-v1.md`](veronica-design-v1.md) ｜ 使用者指南：[`user-guide-zh.md`](../../user-guide/swarm/zh-tw.md)
...
### 文件
- 更新 [`user-guide-zh.md`](../../user-guide/swarm/zh-tw.md) / [`user-guide-en.md`](../../user-guide/swarm/en.md)
